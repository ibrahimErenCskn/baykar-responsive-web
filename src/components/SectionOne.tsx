    ...
    return (
        <div className={"w-full bg-white sm:bg-quinary relative overflow-hidden"}>
            <div className="w-full flex flex-col sm:gap-0 gap-12 pt-0 md:pt-20">
                <svg width="100%" height="100%" className='absolute hidden md:flex'>
                    <polygon points="0,900 1920,900 1920,30" fill="#FEF3C7" />
                </svg>
                <svg width="100%" height="100%" className='absolute flex md:hidden'>
                    <polygon points="0,900 1920,900 1920,-900" fill="#FEF3C7" />
                </svg>
                <div className={'w-full py-12 px-4 text-center sm:text-left gap-8 sm:p-20 sm:gap-20 flex flex-wrap items-center'}>
                    ...
                    <div className='flex justify-center items-center relative flex-1 md:mt-0 mt-12'>
                        <div className={'bg-[#FBBF24] sm:w-[372px] sm:h-[372px] w-[272px] h-[276px] rounded-[50px] overflow-visible'}>
                ...
                <div className="flex md:flex-nowrap flex-wrap py-12 px-4 text-center gap-8 sm:text-left sm:p-20 sm:gap-20 justify-between z-20 bg-primary md:bg-transparent">
